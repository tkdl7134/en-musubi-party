...
insert into member values ('test10', '1111', '朴', 'JE', 'パク', 'ユウ', 'park', 'je', '1997-03-31', '女', 'pje961011@gmail.com', '000-0000-0000', '東京都渋谷区神宮前1-1-1明治神宮', '150-0001', 'profile.jpg' );
delete from member where m_id = 'test10';
...
alter table event_comment add c_no number(5) not null;
create sequence event_comment_seq;
insert into event_comment values (22, '아는형', '축하해', sysdate, '신랑', event_comment_seq.nextval);
