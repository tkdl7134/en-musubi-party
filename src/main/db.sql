...
select w_img_share from wedding_info where e_no = 318;
update wedding_info set w_img_share = '640ff912.png,22538a4d.png,3e43baf2.png,19518a25.png,f36796d9.png,ea70a52e.png,318-photo7.png,318-photo8.png,318-photo9.png' where e_no = 318;
select * from wishlist where e_no = 318;
